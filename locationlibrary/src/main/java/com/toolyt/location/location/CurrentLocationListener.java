...
public class CurrentLocationListener {
    ...
    private LocationUpdateCallback updatedLocationListener;
    ...
    public void getLocation(LocationUpdateCallback updatedLocationListener) {
        startLocationUpdates();
        this.updatedLocationListener = updatedLocationListener;
    }
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            Log.d("CURR_LOC", "" + "Lat: " + mCurrentLocation.getLatitude() + ", " +
                    "Lng: " + mCurrentLocation.getLongitude());
            updatedLocationListener.onLocation(mCurrentLocation);
            updatedLocationListener.onAddress(Utils.getLocalAddress(context, mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude()));
            stopLocationUpdates();
        }
    }
        ...
        mSettingsClient
                ...
                .addOnSuccessListener(new OnSuccessListener<LocationSettingsResponse>() {
                    ...
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                        Log.i("CURR_LOC", "All location settings are satisfied.");
